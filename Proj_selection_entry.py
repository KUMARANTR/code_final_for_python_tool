...
from SKU_and_Picks_Analysis_Tabs import create_monthly_sku_strat_tab, create_sku_strat_aff_tab, build, build2, create_pick_aff_tab
from SKU_and_Picks_Analysis_Tabs import create_sku_strat_aff_tab  #TODO: Replace with line above when Fred is back
from Inbound_outbound_sql_code_testing_summary import create_notebook_page_inbound_outbound_new, get_distinct_dc_names, get_distinct_dc_names_outbound, get_distinct_bu_filter_outbound, get_distinct_channel_filter_outbound, fetch_min_max_dates_outbound, fetch_min_max_dates_inbound
...
def existing_customer():
    ...
    def open_data_summary():
        ...
        Shared.dc_names = get_distinct_dc_names()
        Shared.dc_names_outbound = get_distinct_dc_names_outbound()
        Shared.bu_names_outbound = get_distinct_bu_filter_outbound()
        Shared.channel_names_outbound = get_distinct_channel_filter_outbound()
        Shared.min_date_sql_outbound, Shared.max_date_sql_outbound = fetch_min_max_dates_outbound()
        Shared.min_date_sql_inbound, Shared.max_date_sql_inbound = fetch_min_max_dates_inbound()
        #print(Shared.min_date_sql_outbound)
        ...
        create_monthly_sku_strat_tab(notebook) #TODO: Uncomment when Fred is back
